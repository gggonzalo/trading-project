...
public class ClientsStreamingService(IHubContext<CandlesHub> candlesHubContext, CandlesService candlesService /* IHubContext<RsiCandlesHub> rsiCandlesHubContext, RsiCandlesService rsiCandlesService */)
{
